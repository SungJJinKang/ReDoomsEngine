...
public:
	...
	FShaderParameterConstantBuffer()
		: FShaderParameterTemplate(), bGlobalConstantBuffer(false), MemberVariableMap(), ConstantBufferResource(), ReflectionData(nullptr), ShadowData()
	{
	}
...
DEFINE_SHADER_CONSTANT_BUFFER_TYPE_ALLOW_CULL(
	...
	ADD_SHADER_CONSTANT_BUFFER_MEMBER_VARIABLE_ALLOW_CULL(XMFLOAT4X4, ViewMatrix)
	ADD_SHADER_CONSTANT_BUFFER_MEMBER_VARIABLE_ALLOW_CULL(XMFLOAT4X4, ProjectionMatrix)
