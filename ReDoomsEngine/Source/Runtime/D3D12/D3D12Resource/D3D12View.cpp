...
{
	OfflineDescriptorHeapBlock = FD3D12DescriptorHeapManager::GetInstance()->AllocateOfflineHeapDescriptorHeapBlock(D3D12_DESCRIPTOR_HEAP_TYPE::D3D12_DESCRIPTOR_HEAP_TYPE_RTV, 1);
...
{
	OfflineDescriptorHeapBlock = FD3D12DescriptorHeapManager::GetInstance()->AllocateOfflineHeapDescriptorHeapBlock(D3D12_DESCRIPTOR_HEAP_TYPE::D3D12_DESCRIPTOR_HEAP_TYPE_DSV, 1);
