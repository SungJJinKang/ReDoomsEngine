...
namespace culling
{
	...
	{
		AlignedVec4 mFrustumPlanes[8]; // first 4 planes will be on same cache line
	};
	...
	private:
		...
		char CheckInFrustumSIMDWithTwoPoint(const AlignedVec4* eightPlanes, const Position_BoundingSphereRadius* twoPoint);
