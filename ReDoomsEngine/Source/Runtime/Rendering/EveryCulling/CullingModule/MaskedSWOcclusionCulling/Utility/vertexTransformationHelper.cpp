...
void culling::vertexTransformationHelper::ConvertNDCSpaceThreeVerticesToScreenPixelSpace(const culling::EVERYCULLING_M256F* ndcSpaceVertexX, const culling::EVERYCULLING_M256F* ndcSpaceVertexY, culling::EVERYCULLING_M256F* outScreenPixelSpaceX, culling::EVERYCULLING_M256F* outScreenPixelSpaceY, culling::SWDepthBuffer& depthBuffer)
{
	for (size_t i = 0; i < 3; i++)
	{
...
void culling::vertexTransformationHelper::ConvertClipSpaceThreeVerticesToScreenPixelSpace(const culling::EVERYCULLING_M256F* clipSpaceVertexX, const culling::EVERYCULLING_M256F* clipSpaceVertexY, const culling::EVERYCULLING_M256F* clipSpaceVertexReverseW, culling::EVERYCULLING_M256F* outScreenPixelSpaceX, culling::EVERYCULLING_M256F* outScreenPixelSpaceY, culling::SWDepthBuffer& depthBuffer)
{
	for (size_t i = 0; i < 3; i++)
	{
		//Convert NDC Space Coordinates To Screen Space Coordinates 
...
void culling::vertexTransformationHelper::ConvertNDCSpaceVertexToScreenPixelSpace(const culling::EVERYCULLING_M256F& ndcSpaceVertexX, const culling::EVERYCULLING_M256F& ndcSpaceVertexY, culling::EVERYCULLING_M256F& outScreenPixelSpaceX, culling::EVERYCULLING_M256F& outScreenPixelSpaceY, culling::SWDepthBuffer& depthBuffer)
{
	//Convert NDC Space Coordinates To Screen Space Coordinates 
#if EVERYCULLING_NDC_RANGE == EVERYCULLING_MINUS_ONE_TO_POSITIVE_ONE
