...
namespace culling
{
	...
	private:
		...
		eastl::atomic<size_t> mOccluderCount;
		//char padding[64];
		eastl::array<OccluderData, OCCLUDER_LIST_POOL_SIZE> mOccluderList;
	...
	public:
		...
		eastl::vector<OccluderData> GetSortedOccluderList(const culling::Vec3& cameraWorldPos) const;
